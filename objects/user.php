...
class User {
	...
	*/
	...
	/**
	 * Games user is blocked from joining
	 * Currently only generated by mod tool
	 */
	// public $blockedGames;
	...
	public function blockFromGame($userID, $gameID)
	{
		global $DB;

		$DB->sql_put("UPDATE wD_Users SET blockedGames = ".$gameID." WHERE id=".$userID);
	}
